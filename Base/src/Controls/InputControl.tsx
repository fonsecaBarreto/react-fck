...
export const InputControlComponent: React.FunctionComponent<InputControl.Params> = ({state, name, label, type = "text", placeholder }) =>{
     return(
          <InputWrapper label={label || name} error={state.errors.get[name]}>
               {
