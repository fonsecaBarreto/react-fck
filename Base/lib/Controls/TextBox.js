...
var TextBox = function (_a) {
    ...
    var name = _a.name, label = _a.label, type = _a.type, placeHolder = _a.placeHolder, state = _a.state, className = _a.className;
    return ((0, jsx_runtime_1.jsx)(InputWrapper_1.default, __assign({ label: label !== null && label !== void 0 ? label : name, error: state.errors.get[name], className: className }, { children: type == TextBoxTypes.TEXTAREA ?
            ...
            : type == TextBoxTypes.VIEW ?
                ...
                :
                    (0, jsx_runtime_1.jsx)("input", { type: type, placeholder: placeHolder !== null && placeHolder !== void 0 ? placeHolder : '', value: (_g = (_f = state.data.get) === null || _f === void 0 ? void 0 : _f[name]) !== null && _g !== void 0 ? _g : "", onInput: function (e) { return state.data.onInput(name, e.target.value); } }, void 0) }), void 0));
};
